...
const patientTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content: "Minha mãe precisava de cuidados especiais e a ISA enviou uma enfermeira excelente. Profissional e muito atenciosa com os detalhes.",
    rating: 5,
    initials: "CE",
  ...
  },
  {
    ...
    content: "Serviço impecável! Desde o agendamento até o atendimento, tudo foi organizado e eficiente. Voltarei a usar com certeza.",
    rating: 5,
    initials: "AB",
...
const professionalTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content: "Em 3 meses já superei o que ganhava na clínica com CLT. A plataforma é fácil de usar e o suporte é excelente.",
    rating: 5,
    initials: "MA",
    avatarColor: "bg-teal-100 text-teal-600",
    verified: true,
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={() => setStart((s: number) => Math.max(0, s - 1))}
            disabled={start === 0}
              ...
              {visible.map((t) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full ${t.avatarColor} flex items-center justify-center text-sm font-bold flex-shrink-0`}>
                      {t.initials}
                    </div>
                    <div>
          ...
          <button
            onClick={() => setStart((s: number) => Math.min(maxStart, s + 1))}
