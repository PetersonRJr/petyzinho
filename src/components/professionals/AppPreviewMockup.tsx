      ...
      <div className="flex-1 px-3 py-4">
        ...
        >
          ...
          <div className="flex border-t border-gray-100">
            <button className="flex-1 py-2.5 text-[11px] font-semibold text-gray-400">Recusar</button>
            <button className="flex-1 py-2.5 bg-isa-pink-600 text-white text-[11px] font-bold rounded-br-2xl">Aceitar</button>
          </div>
        </motion.div>
      </div>
    </div>
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-hidden px-3 py-3 space-y-3">
        ...
        <div className="bg-gray-50 rounded-xl p-3 space-y-2">
          {[
            { label: "Paciente", value: "M.S., 72 anos" },
            { label: "Endereço", value: "R. das Flores, 123" },
            { label: "Tipo", value: "Curativo + Troca dreno" },
            { label: "Materiais", value: "Fornecidos pelo paciente" },
          ].map(({ label, value }) => (
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 bg-gradient-to-b from-isa-green-500 to-teal-600 flex flex-col items-center justify-center px-4 pb-6 gap-3">
        ...
        <div className="bg-white/15 backdrop-blur rounded-xl p-3 w-full">
          ...
          <p className="text-white text-[11px] text-center italic">&ldquo;Profissional incrível, muito cuidadosa!&rdquo;</p>
    ...
    <section className="py-20 md:py-28 bg-gradient-to-br from-isa-dark via-isa-gray-900 to-isa-pink-700 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-isa-pink-300 font-semibold text-sm uppercase tracking-wider mb-3">App ISA Saúde</p>
